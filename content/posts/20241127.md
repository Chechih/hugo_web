...
```
{ "insecure-registries":["192.168.56.115:5000"] }
```
...
# ex:
# docker tag mcr.microsoft.com/dotnet/aspnet:8.0 192.168.56.115:5000/mcr.microsoft.com/dotnet/aspnet
```
...
# ex:
# docker push 192.168.56.115:5000/mcr.microsoft.com/dotnet/aspnet
```
...
# ex:
# docker pull 192.168.56.115:5000/mcr.microsoft.com/dotnet/aspnet:8.0
```
...
# ex:
# curl -X GET 10.32.22.65:5000/v2/_catalog
```
...
# ex:
# curl -X GET 192.168.56.115:5000/v2/mcr.microsoft.com/dotnet/aspnet/tags/list
```
