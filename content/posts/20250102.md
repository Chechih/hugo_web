...
```
成功時，會一片黑
![Telnet Successful](/images/20250102/1.jpg "telnet_successful")  
失敗時，有訊息
![Telnet Failure](/images/20250102/2.jpg "telnet_failure")  
...
#ex: Test-NetConnection -ComputerName 192.168.56.1 -Port 8011      
```
執行結果  
成功
